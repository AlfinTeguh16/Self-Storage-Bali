...
<section>
    <div class="flex justify-between items-center">
        <div>
            <h1 class="text-2xl font-semibold mb-2">Operational Expenses</h1>
            <p class="text-gray-600 mb-6">Manage operational expenses (Electricity, Cleaning, Salary, etc.).</p>
        </div>
        <x-button onclick="document.getElementById('addExpenseModal').showModal()" class="gap-1 flex flex-row items-center align-middle justify-center">
            Add Expense <i class="ph-bold ph-plus-circle"></i>
        </x-button>
    </div>
    ...
    <div class="overflow-x-auto w-full rounded-xl border border-gray-200">
        <table class="min-w-full bg-white">
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="hover:bg-orange-50">
                    ...
                    <td class="px-4 py-2 flex justify-center gap-2">
                        <form action="{{ route('expenses.destroy', $expense->id) }}" method="POST" class="inline-block">
                            @csrf
                            @method('DELETE')
                            <x-button variant="delete" type="submit" onclick="return confirm('Are you sure you want to delete this data?')">
                ...
                @empty
                <tr>
                    <td colspan="5" class="px-4 py-6 text-center text-gray-500">No expense data available.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-gray-50/50">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 font-medium">Fill in new expense details</p>
                </div>
            </div>
            ...
            <div class="p-6 space-y-5">
                ...
                <div class="space-y-1.5">
                    ...
                    <div class="relative">
                        ...
                        <input id="amount" type="number" name="amount" placeholder="Example: 150000" required
                ...
                <div class="space-y-1.5">
                    ...
                    <textarea id="description" name="description" rows="3" placeholder="Write expense details..."
